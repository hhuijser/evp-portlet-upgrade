	...
	<liferay-util:buffer var="searchInfo">
		<div class="search-info">
			<span class="keywords">
				...
				if (advancedSearch) {
					if (folder != null) {
						message = LanguageUtil.format(pageContext, "advanced-search-in-x", new Object[] {HtmlUtil.escape(folder.getName())}, false);
					}
					else {
					...
					if (folder != null) {
						message = LanguageUtil.format(pageContext, "searched-for-x-in-x", new Object[] {HtmlUtil.escape(keywords), HtmlUtil.escape(folder.getName())}, false);
					}
					else {
