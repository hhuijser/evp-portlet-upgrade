...
<aui:script use="aui-io-request,aui-loading-mask-deprecated,aui-parse-content,aui-toggler,autocomplete-base,autocomplete-filters,liferay-notice">
	...
	Liferay.provide(
		...
		function() {
			...
			var unselectedTargets = Liferay.Util.listUncheckedExcept(document.<portlet:namespace />fm, '<portlet:namespace />allRowIds');
			...
			document.<portlet:namespace />fm.<portlet:namespace />unselectedTargets.value = unselectedTargets;
